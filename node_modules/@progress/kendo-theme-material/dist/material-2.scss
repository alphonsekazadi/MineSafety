@forward "../scss/index.scss" with (
	...
	$kendo-button-shadow: (0px 1px 5px 0px rgba(0, 0, 0, 0.2),
 0px 3px 1px 0px rgba(0, 0, 0, 0.12),
0px 2px 2px 0px rgba(0, 0, 0, 0.14)) !default,
	$kendo-calendar-range-bg: rgba(63, 81, 181, .25) !default,
	$kendo-calendar-range-start-bg: linear-gradient(to right, #f5f5f5 0%, #f5f5f5 50%, rgba(63, 81, 181, .25) 50%, rgba(63, 81, 181, .25) 100%) !default,
	$kendo-calendar-range-end-bg: linear-gradient(to left, #f5f5f5 0%, #f5f5f5 50%, rgba(63, 81, 181, .25) 50%, rgba(63, 81, 181, .25) 100%) !default,
);
