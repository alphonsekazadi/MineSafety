...
exports.headersReducer = exports.HEADERS_ACTION = void 0;
...
})(HEADERS_ACTION || (exports.HEADERS_ACTION = HEADERS_ACTION = {}));
...
var headersReducer = function (state, action) {
    switch (action.type) {
        case HEADERS_ACTION.toggle: {
            ...
            return (0, exports.headersReducer)(state, tslib_1.__assign(tslib_1.__assign({}, action), { type: existing && (existing.expand)
        ...
        case HEADERS_ACTION.expand: {
            ...
            if (existing_1 && existing_1.expand === true) {
                ...
                return state.map(function (s) { return s === existing_1 ? (tslib_1.__assign(tslib_1.__assign({}, existing_1), { expand: true })) : s; });
            }
            else {
        ...
        case HEADERS_ACTION.collapse: {
            ...
            var newState = state.slice()
                ...
                .map(function (h) { return (tslib_1.__assign(tslib_1.__assign({}, h), { expand: Boolean(h.expand) })); })
