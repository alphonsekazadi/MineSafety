 ...
 */
export declare interface SankeyTooltip extends SankeyTooltip_2, TooltipAppendTo {
    /**
 ...
 * @hidden
 */
export declare interface SankeyTooltipProps extends TooltipAppendTo {
    /**
 ...
 */
export declare interface SparklineProps extends Omit<BaseChartProps, 'drilldownState' | 'onDrilldown' | 'onLegendItemClick' | 'onLegendItemHover' | 'onNoteClick' | 'onNoteHover' | 'axisLabelClick'> {
    /**
 ...
 * @hidden
 */
declare interface TooltipAppendTo {
    /**
