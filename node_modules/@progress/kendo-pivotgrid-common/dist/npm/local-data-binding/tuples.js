...
exports.createLocalDataState = exports.addMultipleMeasures = exports.createTuples = exports.rootFields = void 0;
...
var sortFunc = function (descriptor, axe) {
    return function (a, b) {
        ...
        var sortableA = axe.sortValue((0, utils_2.splitKeyValue)(a[0])[1]);
        var sortableB = axe.sortValue((0, utils_2.splitKeyValue)(b[0])[1]);
...
var mergeData = function (src, dest, exclude) {
    src.forEach(function (srcChild, k) {
        if (!exclude[k]) {
            var destChild = (0, utils_2.subNode)(dest, k);
...
var childrenByKeys = function (dataTree, keys, exclude) {
    ...
    var _loop_1 = function (i) {
        ...
        if (next) {
        ...
        else if (i < keys.length - 1 && Array.from(element).some(function (e) { return (0, utils_2.splitKeyValue)(e[0])[0] === keys[i]; })) {
            var curLevel_1 = [];
            ...
            if (Array.from(element).some(function (e) { return (0, utils_2.splitKeyValue)(e[0])[0] === keys[i]; })) {
...
var rootFields = function (definitions) {
    ...
    definitions.forEach(function (item) {
        if (item.name.length === 1 && !(0, utils_2.splitKeyValue)(item.name[0])[1]) {
...
var createTuples = function (axesSettings, definitions, dataTree, sortDescriptors, excludeFields) {
    var parentFields = (0, exports.rootFields)(definitions);
    var flatMembers = [];
    ...
    var _loop_2 = function (i) {
        ...
        currDef.name.forEach(function (element, index) {
            var _a;
            var _b = (0, utils_2.splitKeyValue)(element), field = _b[0], value = _b[1];
            ...
            if (value) {
                ...
                for (var c = 0; c < children.length; c++) {
                    ...
                    var caption = (0, utils_2.splitKeyValue)(leafValue)[1];
...
var addMeasure = function (tuple, measure) {
    ...
    var tupleCopy = (0, utils_1.copy)(tuple);
...
var addMultipleMeasures = function (tuples, measures) {
    ...
    return (0, utils_1.reverseColumnsByMeasures)(result);
};
...
var createLocalDataState = function (args) {
    ...
    var colTuples = columnAxes.length ?
        (0, exports.createTuples)(columnSettings, columnAxes, dataTree.get(fields.columnsData), sort, exclude) :
        measures.map(function (m) { return ({ members: [measureToMember(m)] }); });
    var columnTuples = columnAxes.length > 0 ? (0, exports.addMultipleMeasures)(colTuples, measures) : colTuples;
    var rowTuples = rowAxes.length ? (0, exports.createTuples)(rowSettings, rowAxes, dataTree, sort, exclude) : [{ members: [] }];
    var resultData = (0, dataReader_1.readData)(dataTree, rowTuples, columnTuples, fields, columnSettings, rowSettings, measures);
    return {
