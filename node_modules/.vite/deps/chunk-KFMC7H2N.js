...
var Matrix = function(Class3) {
  ...
  Matrix2.prototype.toString = function toString2(precision, separator) {
...
var PDFString = function(PDFValue3) {
  ...
  PDFString2.prototype.toString = function toString2() {
    return this.value;
  };
  return PDFString2;
}(PDFValue);
...
var PDFName = function(PDFValue3) {
  ...
  PDFName2.prototype.toString = function toString2() {
    return this.name;
  };
  return PDFName2;
}(PDFValue);
...
var browser4 = userAgent ? detectDesktopBrowser(userAgent) : null;
var mobileOS = userAgent ? detectMobileOS(userAgent) : null;
var touch = isWindowAvailable() && "ontouchstart" in window;
var msPointers = browser4 && !browser4.chrome && window.MSPointerEvent;
var pointers = browser4 && !browser4.chrome && window.PointerEvent;
...
//# sourceMappingURL=chunk-KFMC7H2N.js.map
