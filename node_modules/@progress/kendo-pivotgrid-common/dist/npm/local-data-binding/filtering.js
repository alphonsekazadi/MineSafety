...
exports.initializeFiltering = void 0;
...
var initializeFiltering = function (rows, columns, filter) {
    ...
    var predicate = compositeFilter ? (0, kendo_data_query_1.compileFilter)(compositeFilter) : function () { return true; };
...
exports.initializeFiltering = initializeFiltering;
